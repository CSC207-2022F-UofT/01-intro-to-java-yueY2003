...
public class Basics {
    ...
    public static String split(String to_split) {
        ...
        ret.append(s[0].charAt(0));
        ret.append(s[1].charAt(0));
        ret.append(s[2].charAt(0));
        ret.append(s[3].charAt(0));
        ret.append(s[4].charAt(0));
        ret.append(s[5].charAt(0));
        ret.append(s[6].charAt(0));
